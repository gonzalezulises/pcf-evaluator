  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold">Reporte — {evalRows[0].name}</h1>
      </div>
      <Card>
        <CardHeader><CardTitle>Reporte interactivo</CardTitle></CardHeader>
        <CardContent>
          <p className="text-muted-foreground">Los gráficos de radar, barras apiladas y donut se implementarán en la Fase 2.</p>
        </CardContent>
      </Card>
    </div>
  );
