  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold">Análisis de brechas — {evalRows[0].name}</h1>
      </div>
      <Card>
        <CardHeader><CardTitle>Análisis de brechas</CardTitle></CardHeader>
        <CardContent>
          <p className="text-muted-foreground">El heatmap y lista priorizada de brechas se implementarán en la Fase 2.</p>
        </CardContent>
      </Card>
    </div>
  );
